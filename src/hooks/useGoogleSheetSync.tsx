...
const ACTIVE_POLL_INTERVAL = 1800000;  // Increased to 1800s (30m) to reduce quota usage
const IDLE_POLL_INTERVAL = 3600000;   // Increased to 3600s (60m) when tab is idle
