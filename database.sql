-- ============================================================
-- Ameen Portal – MySQL Schema
-- Run this once on your Asura hosting MySQL database:
--   mysql -u madanime_ameen -p madanime_ameen < database.sql
-- ============================================================
...
CREATE TABLE IF NOT EXISTS `members` (
  ...
  `nomineeAddress`         varchar(512)  DEFAULT NULL,
...
-- ------------------------------------------------------------
-- PINs (role-based PIN authentication)
-- ------------------------------------------------------------
